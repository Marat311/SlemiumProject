...
public class GetElementAttribute {
    public static void main(String[] args) {
        ...
        //using value atribute of input text box to extract the text inside
        System.out.println("searchBox.getAttribute(\"value\") = " + searchBox.getAttribute("value"));

        //HOmework identify the google search button and get below attributes
        //class, type, value and anything that we see
